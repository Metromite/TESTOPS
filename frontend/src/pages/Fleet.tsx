...
interface VehicleRow {
  id: string; number: string; type: string; division: string; status: string; capacity_tons?: number | null; pallet_capacity?: number | null;
...
function VehiclesPanel({ meta }: { meta: MetaOptions }) {
  ...
  function startEdit(v: VehicleRow) {
    setEditingId(v.id);
    setForm({ number: v.number, type: v.type, division: v.division, status: v.status, capacity_tons: v.capacity_tons ?? "", pallet_capacity: v.pallet_capacity ?? "" });
