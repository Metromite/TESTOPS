...
export default function BulkOrganizer() {
  ...
  function openInvoiceForStore(store: Building) {
    setEditingInvoice(null); setInvoiceBuildingLocked(true); setInvoiceCustomerLocked(false);
