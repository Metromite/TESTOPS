      ...
      <main className="bulk-game-board">
        ...
        <section className="bulk-game-section">
          ...
          {showScheduleManager && <GlassCard className="bulk-builder-panel">
            ...
            <div className="bulk-schedule-list">{(defaults.customer_schedules||[]).map(s=><span key={s.id}><b>{s.customer_name}</b> · {s.days.map(d=>["Sun","Mon","Tue","Wed","Thu","Fri","Sat"][d]).join(", ")}</span>)}</div>
          </GlassCard>}
