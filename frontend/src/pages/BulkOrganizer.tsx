...
export default function BulkOrganizer() {
  ...
  const capacityFor = (cfg: VehicleConfig, v: any) => Number(cfg.capacity || v.capacity || v.pallet_capacity || v.capacity_pallets || defaultCapacity(v.type));
  ...
  if (loading) return <div className="page bulk-planner-page"><GlassCard style={{ padding: 28 }}>Loading Bulk Organizer…</GlassCard></div>;
