...
export default function BulkOrganizer() {
  ...
  const [bulkWallpaper, setBulkWallpaper] = useState<string | null>(null);
  const [bulkTheme, setBulkTheme] = useState(() => document.documentElement.getAttribute("data-theme") || (document.documentElement.classList.contains("dark") ? "dark" : "light"));
