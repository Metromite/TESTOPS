...
import { getFilterOptions } from "../services/dashboardKpis";
...
import { getDrivers, getMetaOptions } from "../services/operational";
...
export default function Dashboard() {
  ...
  function loadFilterMeta() {
    getMetaOptions<{ vehicle_types?: string[]; route_types?: string[] }>().then((m) => {
  ...
  useOperationalRealtime("dashboard-imports", ["import_batches"], () => { loadFilterMeta(); triggerDashboardRefresh(); });
