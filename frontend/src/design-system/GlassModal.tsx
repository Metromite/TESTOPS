...
import { fadeIn, springSheetIn } from "./motion";
            ...
            */}
            <Dialog.Content asChild forceMount>
              ...
              */}
              ...
              >
                <motion.div
                  // ITEM PASS (iOS 27 / Liquid Glass): real spring entry
                  // (springSheetIn) with a small blur->sharp resolve,
                  // replacing the fixed-duration scaleIn. The centering/
                  // transform-ownership bugfix noted above is untouched -
                  // this only swaps which animation values drive the
                  // same motion.div, not its positioning.
                  {...springSheetIn}
                  className={cn(
