...
const fieldBase =
  "w-full rounded-[11px] border border-[var(--glass-border)] bg-[var(--glass-bg)] px-3 py-2 text-[12px] text-ink placeholder:text-muted/70 backdrop-blur-glass backdrop-saturate-[165%] focus-visible:outline-none focus-visible:border-[var(--cyan)] disabled:opacity-50";
