  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className={cn(
          "relative flex items-center gap-1.5 rounded-md px-3.5 py-2 text-[13.5px] font-semibold transition-colors duration-150",
          (isActiveGroup || open) ? "text-white" : "text-muted hover:text-white hover:bg-[var(--blue)]"
        )}
      >
        {isActiveGroup && (
          <motion.span
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    cn(
                      ...
                      isActive ? "bg-[var(--blue)] text-white" : "text-muted hover:bg-[var(--blue)] hover:text-white"
                    )
                  }
                >
                  {item.icon}
