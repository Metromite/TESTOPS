...
export function GlassSidebarShell({ children }: { children: ReactNode }) {
  return (
    ...
    <nav className="glass-level-2 top-nav sticky top-0 z-50 flex min-w-0 flex-wrap items-center gap-1 border-b border-[var(--glass-border)] px-4 py-2.5 shadow-[0_1px_0_rgba(255,255,255,0.04)_inset]">
      {children}
    </nav>
  );
}
