...
function navigateWithViewTransition(to: string, navigate: (to: string) => void) {
  ...
  return (
    <NavLink
      ...
      onClick={(e) => {
        ...
        e.preventDefault();
        navigateWithViewTransition(to, navigate);
      }}
      className={({ isActive }) =>
        cn(
              ...
              {items.map((item) => (
                <NavLink
                  ...
                  onClick={(e) => {
                    ...
                    e.preventDefault();
                    setOpen(false);
                    navigateWithViewTransition(item.to, navigate);
                  }}
                  className={({ isActive }) =>
                    cn(
