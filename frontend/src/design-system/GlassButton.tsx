  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-[11px] border font-semibold focus-visible:outline-none disabled:opacity-50 disabled:pointer-events-none",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-[rgba(13,24,41,.43)] text-ink border-[rgba(255,255,255,.23)] backdrop-blur-[42px] backdrop-saturate-[190%] shadow-[inset_0_1px_0_rgba(255,255,255,.20)]",
        ...
        subtle: "bg-[rgba(13,24,41,.43)] text-ink border-[rgba(255,255,255,.23)] backdrop-blur-[42px] backdrop-saturate-[190%] shadow-[inset_0_1px_0_rgba(255,255,255,.20)]",
      },
      size: {
