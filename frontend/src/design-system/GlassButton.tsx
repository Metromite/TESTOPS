  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-[11px] border font-semibold focus-visible:outline-none disabled:opacity-50 disabled:pointer-events-none",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-[var(--dispatch-glass-inner)] text-ink border-[var(--dispatch-glass-border)] backdrop-blur-[24px] backdrop-saturate-[165%] shadow-[inset_0_1px_0_rgba(255,255,255,.12)]",
        ...
        subtle: "bg-[var(--dispatch-glass-inner)] text-ink border-[var(--dispatch-glass-border)] backdrop-blur-[24px] backdrop-saturate-[165%] shadow-[inset_0_1px_0_rgba(255,255,255,.12)]",
      },
      size: {
