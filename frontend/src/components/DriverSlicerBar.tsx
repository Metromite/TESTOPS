        ...
        {options.length > 12 && (
          <div className="relative shrink-0">
            ...
            <input
              ...
              className="w-[140px] rounded-md border border-[var(--glass-border)] dashboard-slicer-input py-1.5 pl-7 pr-2 text-[12.5px] text-ink placeholder:text-muted focus:outline-none"
            />
          </div>
        )}
