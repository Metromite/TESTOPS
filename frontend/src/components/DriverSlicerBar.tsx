      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <button
          ...
          className={cn(
            ...
            allActive ? "bg-[var(--blue)] text-white" : "bg-[var(--glass-bg)] text-ink hover:text-ink"
          )}
        ...
        {selected.length > 0 && (
          <button
            type="button"
            onClick={() => onChange([])}
            className="shrink-0 whitespace-nowrap rounded-md px-2 py-1.5 text-[12px] font-medium text-[var(--blue)] hover:underline"
          >
        ...
        {visibleOptions.map((opt) => {
          ...
          return (
            <button
              ...
              className={cn(
                "shrink-0 whitespace-nowrap rounded-full px-3 py-1.5 text-[12.5px] font-semibold transition-colors duration-150",
                isSelected ? "bg-[var(--blue)] text-white" : "bg-[var(--glass-bg)] text-ink hover:text-ink"
              )}
