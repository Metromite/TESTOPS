        ...
        <AnimatePresence>
          {open && (
            <motion.div
              ...
              className="glass-slicer-menu max-h-[280px] overflow-y-auto rounded-[14px] border border-[var(--glass-border)] bg-[var(--glass-bg-3)] p-2 shadow-elevation2 backdrop-blur-[var(--glass-blur-3)] backdrop-saturate-[200%]"
            >
