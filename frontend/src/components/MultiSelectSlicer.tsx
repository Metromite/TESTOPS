  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className={cn(
          "dashboard-slicer-trigger flex items-center gap-1.5 rounded-[12px] px-3.5 py-2 text-[13px] font-semibold transition-colors duration-150",
          selected.length ? "is-selected" : ""
        )}
      >
        ...
        <AnimatePresence>
          {open && (
            <motion.div
              ...
              className="dashboard-slicer-menu max-h-[280px] overflow-y-auto rounded-[16px] border p-2"
            >
