...
// Direct primary client for feature-owned tables whose schema is maintained in the primary DispatchOPS database.
export const primarySupabase = primaryClient;
