...
export async function deleteDefaultPriceChangeArea(id:string){return rpc<boolean>('dispatchops_price_change_admin_delete_default_area',{p_key:await adminKey(),p_id:id});}
