-- Price Change global default areas.
-- Existing campaign-specific areas are promoted into one persistent global list.
...
-- Seed once from every area already configured in any existing Price Change list.
...
-- Admin payload exposes the global list once; frontend no longer derives defaults from the selected campaign.
...
-- Driver portal always receives the global defaults. Historical campaign areas are not the source of truth anymore.
